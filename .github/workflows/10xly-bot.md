...
## How to Read Files
- use get_file_contents to download a file. it saves to /tmp/gh-aw/mcp-payloads/
- use list_directory on /tmp/gh-aw/mcp-payloads/ to find the subdirectory, then list_directory inside that to find the file, then read_file to read it.
- do NOT use curl.
- if you cannot find the file after one attempt, just open an issue based on the repo name and description — do not keep retrying.
